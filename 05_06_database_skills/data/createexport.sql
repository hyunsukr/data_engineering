...
--
-- Table structure for table `SemesterSchedule`
--

DROP TABLE IF EXISTS `SemesterSchedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SemesterSchedule` (
  `Mnemonic` varchar(255) NOT NULL,
  `InstructorComputingID` varchar(255) NOT NULL,
...
-- Dump completed on 2023-03-12 21:44:17
